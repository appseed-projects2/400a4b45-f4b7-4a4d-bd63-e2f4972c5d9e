...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-01-08 16:10`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/400a4b45-f4b7-4a4d-bd63-e2f4972c5d9e.git
$ cd 400a4b45-f4b7-4a4d-bd63-e2f4972c5d9e
```
